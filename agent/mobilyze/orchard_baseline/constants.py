...
CURRENT_TART_APP = CURRENT_BIN / "tart.app"
...
SUPPORT_ROOT = Path("/Library/Application Support/Mobilyze/OpenSWEOrchard")
SUPPORT_ROOT_OWNER = "root"
SUPPORT_ROOT_UID = 0
SUPPORT_ROOT_MODE = 0o750
ORCHARD_HOME = SUPPORT_ROOT
SECRETS_ROOT = SUPPORT_ROOT / "secrets"
ADMIN_TOKEN = SECRETS_ROOT / "bootstrap-admin"
WORKER_TOKEN = SECRETS_ROOT / "worker-bootstrap"
...
TAILSCALE_BINARY = Path("/Applications/Tailscale.app/Contents/MacOS/Tailscale")
