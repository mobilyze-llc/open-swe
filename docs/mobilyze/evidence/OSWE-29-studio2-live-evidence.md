...
Captured on `2026-07-19`, with the final runtime snapshot at `2026-07-19T21:01:10Z`.
...
- Live-tested tooling commit: `f9cd2721f916b593835c08b7d50a972b15e7bf51`; the deployed
  installer SHA-256 was
  `d119b4d30f6c99d26b1f431a07184fae62009199b6beb5c8c80adedffa92faef`, matching
...
API key. `LANGSMITH_API_KEY` was not added to the service environment, manifest, repository, or
evidence; the existing host environment was sourced only for redacted CLI authentication checks.
...
| Linear | OSWE-29 comment `5b5014c0-a898-45e7-8214-d34a4e738287` | `263e4653-2d85-5f58-81db-2fb3a2b6df9b` | run `019f7c22-57fb-7860-8318-ab31a93f8b53` reached terminal `error` before a provider call; metadata records `mobilyze-llc/open-swe` |
...
The Linear run terminated during upstream GitHub-token resolution because the trigger metadata
contains `eric@mobilyze.com`, while the authenticated LangSmith identity is `eric@litman.org`.
That terminal pre-model failure is retained as status evidence and did not introduce a provider
credential or alternate model path.
